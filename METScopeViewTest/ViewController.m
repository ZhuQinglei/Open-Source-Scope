...
- (void)getInterfaceValuesFromScopeView {
    ...
    [kObjectChannel1Switch setOn:[kObjectScopeView channel1Enabled]];
    [kObjectChannel2Switch setOn:[kObjectScopeView channel2Enabled]];
    [kObjectTrackingLevelSlider setValue:[kObjectScopeView trackingLevel]];
    [kObjectFreezeSwitch setOn:false];
...
- (IBAction)toggleChannel1Switch:(id)sender {
    //do nothing
    printf("This is a testing toggle 1");
    if ([kObjectScopeView channel1Enabled])
        [kObjectScopeView setChannel1Enabled:false];
    else
        [kObjectScopeView setChannel1Enabled:true];
    
    //[kObjectScopeView togglePinchZoom:'x'];
}

- (IBAction)toggleChannel2Switch:(id)sender {
    //do nothing
    printf("This is a testing toggle 2");
    if ([kObjectScopeView channel2Enabled])
        [kObjectScopeView setChannel2Enabled:false];
    else
        [kObjectScopeView setChannel2Enabled:true];
...
- (IBAction)SetFreeze:(id)sender {
    [audioIn setFreeze: [(UISwitch*)sender isOn]];
}

#pragma mark -
#pragma mark Audio Callback
//initial buffer create??????- Li Yueran
